    ...
    try:
        ...
        thread = client.beta.threads.create(
            messages=[
                {
                    "role": "user",
                    "content": "Create a list of 10 multiple-choice Basketball trivia questions based on the value of user_input. At the end, include a list of the correct answers."
                }
            ]
        )
